...
import { LoginPage, CallbackPage, ChatPage, ProfilePage, AdminPage, OpenRouterCallbackPage } from './pages';
    ...
    <BrowserRouter>
      <AuthProvider>
        <Routes>
          ...
          <Route path="/openrouter/callback" element={<OpenRouterCallbackPage />} />
